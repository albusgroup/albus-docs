...
{/* TODO(5): delete this page with the 'For coding agents' group; drop beta wording. Check: agents/docs.mdx is the URL the CLI prints for agents — keep it as a hidden page or remove? */}
...
the rules that matter — caller-chosen session ids, invocation keys, secret
...
ticket id, pass an invocation key so retries are safe, and read
