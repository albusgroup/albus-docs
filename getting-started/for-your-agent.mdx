...
```text
Set up Albus for me. Read https://docs.albus.sh/agents/setup.md and follow it
...
| URL | What it is |
|---|---|
| [/agents/setup.md](https://docs.albus.sh/agents/setup.md) | Setup procedure, imperative and complete |
| [/agents/examples.md](https://docs.albus.sh/agents/examples.md) | Runnable programs to adapt |
