...
TypeScript, `--wait-timeout` in the CLI. Omit it and the call returns as soon as
the run is accepted — see [Run a session](/guides/run-a-session#waiting-for-the-reply).
</Note>
