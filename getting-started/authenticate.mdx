...
On a machine with no browser — a container, a remote box, CI — use
`--no-browser`, which prints the authorization URL and waits for you to open it
elsewhere:
...
This is also how a coding agent signs you in: it prints the URL, you click it.
See [Set up from a coding agent](/agents/setup).
