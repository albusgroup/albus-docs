...
| [OAuth 2.0 client credentials](#3-oauth-20-client-credentials) | Your server already trusts an identity provider, and Albus should obtain an access token from the provider at launch. |
