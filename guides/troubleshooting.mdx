...
{/* TODO(10,?): the CLI prints this URL on errors — propose keeping it live but out of the nav, like agents/docs. */}

{/* TODO(1): drop the 'not in the Albus beta' and 20-run quota entries. */}
