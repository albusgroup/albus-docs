...
|---|---|---|---|
| `400` | The request was rejected before anything ran: unknown tool name, malformed MCP server declaration, missing `model`, malformed secret reference, or an invalid pagination cursor. | No | Correct the request. |
